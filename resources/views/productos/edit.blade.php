...
<div class="d-flex align-items-center mb-4">
    ...
    <h2 class="mb-0"><i class="bi bi-pencil-square text-warning"></i> Editar Producto</h2>
</div>
        ...
        <form action="{{ route('productos.update', $producto) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    @else
                        <img id="previewImg" src="" style="max-height:80px; border-radius:8px; display:none;" class="mb-2">
                    @endif
                ...
                <div class="col-md-6">
                    ...
                    <small class="text-muted">Deja vacío para conservar el PDF actual</small>
